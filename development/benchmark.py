...
URL = "http://127.0.0.1:8784/exapp_storage"
...
def main():
    ...
    print(f"Starting benchmark against {URL} with {PROCESSES} processes, "
    ...
    with multiprocessing.Pool(PROCESSES) as pool:
        # Launch all workers
        results = [
            pool.apply_async(worker, (REQUESTS_PER_PROCESS, URL, AUTH))
